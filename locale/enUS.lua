...
function TitanPanelReputation:UpdateLanguageTab(tab)
    for i, v in pairs(tab) do
        TitanPanelReputation:GetLangTab()[i] = v
    end
end

function TitanPanelReputation:LangenUS()
    local tab = {
        -- General
        ...
        ["LID_SHOW_FRIENDSHIPS"] = "Show Frienships",
        ...
        ["LID_SHOW_FRIENDLY"] = "Show Friendlyn",
        ...
        ["LID_SHOW_ANNOUNCE_FRAME"] = "Standing Change Achivements",
